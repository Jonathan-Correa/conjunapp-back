...
def seed_database(db: Session) -> None:
    ...
    areas = [
        CommonArea(
            ...
            name="Salon social",
            category="salon",
            description="Salón para eventos sociales del conjunto.",
            capacity=80,
            hourly_rate=Decimal("90000"),
            has_cost=True,
            requires_approval=True,
            rules="Maximo hasta las 11 p.m.",
        ...
        CommonArea(
            ...
            has_cost=True,
            rules="Uso con zapatos deportivos.",
        ),
        CommonArea(
            complex_id=complex_.id,
            name="BBQ",
            ...
            has_cost=True,
            requires_approval=True,
            rules="Entrega limpia obligatoria.",
        ...
        CommonArea(
            ...
            name="Piscina",
            category="piscina",
            description="Piscina comunal. Consulta horarios de baño.",
            capacity=30,
            hourly_rate=Decimal("0"),
            has_cost=False,
            is_bookable=False,
            rules="Ingreso con gorro. Zona informativa (sin reserva).",
        ),
        CommonArea(
            complex_id=complex_.id,
            name="Coworking",
            ...
            has_cost=True,
            rules="Reserva maxima de 4 horas.",
